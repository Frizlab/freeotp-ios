...
class ImageViewController : UICollectionViewController, UICollectionViewDelegateFlowLayout {
	...
	fileprivate var sections: PHFetchResult<PHAsset>!
	fileprivate var items: PHFetchResult<PHAsset>!
	...
	override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		...
		PHImageManager.default().requestImage(for: a, targetSize: i.bounds.size, contentMode: .aspectFill, options: nil, resultHandler: { (image: UIImage?, objects: [AnyHashable: Any]?) -> Void in
